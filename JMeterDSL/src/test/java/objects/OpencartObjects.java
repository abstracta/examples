...
public class OpencartObjects {
    ...
    static String baseUrl="http://opencart.abstracta.us";
    static String product="MacBook";


    public static DslHttpSampler goToOpencart = httpSampler("1. Go to Opencart",baseUrl+"/")
    ...
    public static DslTransactionController clickProduct = transaction("2. Click product",
    ...
    public static DslTransactionController addToCart =transaction("3. Add to cart",
            ...
            httpSampler("Agregar al carrito - info",baseUrl+"/index.php?route=common/cart/info%20")
                    .header("Host","opencart.abstracta.us")
                    .header("Connection","keep-alive")
                    .header("Accept","text/html, */*; q=0.01")
                    .header("User-Agent","Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.82 Safari/537.36")
    ...
    public static DslHttpSampler viewCart = httpSampler("4. View cart", baseUrl+"/index.php?route=checkout/cart ")
            .header("Host","opencart.abstracta.us")
            .header("Connection","keep-alive")
            .header("Upgrade-Insecure-Requests","1")
            .header("User-Agent","Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.82 Safari/537.36")
    ...
    public static DslTransactionController goToCheckout = transaction("5. Checkout",
    ...
    public static DslTransactionController selectGuestCheckout = transaction("6. Select guest checkout",
    ...
    public static DslHttpSampler selectCountry = httpSampler("7. Select country", baseUrl+"/index.php?route=checkout/checkout/country&country_id=225")
            .header("Host","opencart.abstracta.us")
            .header("Connection","keep-alive")
            .header("sec-ch-ua","\"Google Chrome\";v=\"93\", \" Not;A Brand\";v=\"99\", \"Chromium\";v=\"93\"")
            .header("Accept","application/json, text/javascript, */*; q=0.01")
    ...
    public static DslTransactionController sendBillingDetails = transaction("8. Send billing details",
    ...
    public static DslTransactionController sendShippingMethod = transaction("9. Send shipping method",
    ...
    public static DslTransactionController sendPaymentMethod = transaction("10. Send payment method",
    ...
    public static DslTransactionController confirmOrder = transaction("11. Confirm order",
